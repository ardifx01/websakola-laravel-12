...
@section('content')
    ...
    <section class="u-bg-overlay g-bg-img-hero g-bg-bluegray-opacity-0_3--after"
        style="background-image: url({{ URL::asset('build/assets/img-temp/1920x800/img1.jpg') }});">
        <div class="container u-bg-overlay__inner text-center g-pt-150 g-pb-70">
            <div class="g-mb-100">
                <span class="d-block g-color-white g-font-size-20 text-uppercase g-letter-spacing-5 mb-4">The Exhibition
                    of</span>
                <h1
        ...
        <div class="container g-py-100">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="js-carousel text-center g-pt-60" data-infinite="true" data-autoplay="true" data-fade="true"
                        data-speed="5000">
                        <div class="js-slide">
                            <blockquote class="lead g-color-black g-font-size-22 g-line-height-2 mb-4">Dear Htmlstream team,
                                I just bought the Unify template some weeks ago. The template is really nice and offers
                                quite a large set of options.</blockquote>
                            <span class="d-block g-color-black g-font-size-17 mb-4">Katarina Ramirez, Designer</span>
                            <img class="d-inline-block g-width-60 g-height-60 g-brd-around g-brd-3 g-brd-white rounded-circle"
                                src="{{ URL::asset('build/assets/img-temp/100x100/img4.jpg') }}" alt="Image Description">
                        </div>

                        <div class="js-slide">
                            <blockquote class="lead g-color-black g-font-size-22 g-line-height-2 mb-4">Hi there purchased a
                                couple of days ago and the site looks great, big thanks to the htmlstream guys, they gave me
                                some great help with some fiddly setup issues.</blockquote>
                            <span class="d-block g-color-black g-font-size-17 mb-4">Sara Anderson, Developer</span>
                            <img class="d-inline-block g-width-60 g-height-60 g-brd-around g-brd-3 g-brd-white rounded-circle"
                                src="{{ URL::asset('build/assets/img-temp/100x100/img5.jpg') }}" alt="Image Description">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="dzsparallaxer auto-init height-is-based-on-content g-bg-white"
        ...
        <div class="container g-py-100">
            <div class="cbp" data-animation="quicksand" data-x-gap="30" data-y-gap="30"
                data-media-queries='[
                 {"width": 1500, "cols": 2},
                 {"width": 1100, "cols": 2},
                 {"width": 800, "cols": 2},
                ...
                <div class="cbp-item"
                    ...
                    <div class="u-block-hover g-parent">
                        <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                            src="{{ URL::asset('build/assets/img-temp/600x450/img2.jpg') }}" alt="Image description">
                        <div
                            ...
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="{{ URL::asset('build/assets/img-temp/600x450/img2.jpg') }}">
                ...
                <div class="cbp-item"
                    ...
                    <div class="u-block-hover g-parent">
                        <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                            src="{{ URL::asset('build/assets/img-temp/600x450/img3.jpg') }}" alt="Image description">
                        <div
                            class="d-flex w-100 u-block-hover__additional--fade u-block-hover__additional--fade-in h-100 g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                <li class="list-inline-item">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="{{ URL::asset('build/assets/img-temp/600x450/img3.jpg') }}">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="cbp-item"
                    ...
                    <div class="u-block-hover g-parent">
                        <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                            src="{{ URL::asset('build/assets/img-temp/600x450/img4.jpg') }}" alt="Image description">
                        <div
                            class="d-flex w-100 u-block-hover__additional--fade u-block-hover__additional--fade-in h-100 g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                <li class="list-inline-item">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="{{ URL::asset('build/assets/img-temp/600x450/img4.jpg') }}">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="cbp-item"
                    ...
                    <div class="u-block-hover g-parent">
                        <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                            src="{{ URL::asset('build/assets/img-temp/600x650/img1.jpg') }}" alt="Image description">
                        <div
                            class="d-flex w-100 u-block-hover__additional--fade u-block-hover__additional--fade-in h-100 g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                <li class="list-inline-item">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="{{ URL::asset('build/assets/img-temp/600x650/img1.jpg') }}">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="cbp-item"
                    ...
                    <div class="u-block-hover g-parent">
                        <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                            src="{{ URL::asset('build/assets/img-temp/600x450/img5.jpg') }}" alt="Image description">
                        <div
                            class="d-flex w-100 u-block-hover__additional--fade u-block-hover__additional--fade-in h-100 g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                <li class="list-inline-item">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="{{ URL::asset('build/assets/img-temp/600x450/img5.jpg') }}">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="cbp-item"
                    ...
                    <div class="u-block-hover g-parent">
                        <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                            src="{{ URL::asset('build/assets/img-temp/600x300/img1.jpg') }}" alt="Image description">
                        <div
                            class="d-flex w-100 u-block-hover__additional--fade u-block-hover__additional--fade-in h-100 g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                <li class="list-inline-item">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="{{ URL::asset('build/assets/img-temp/600x300/img1.jpg') }}">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
    ...
    <section class="container-fluid px-0">
        <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-bg-cover g-bg-black-opacity-0_6--after"
            ...
            <div class="text-center g-pos-rel g-z-index-1 g-px-50 g-py-200">
                <a class="js-fancybox d-block mb-5" href="javascript:;"
                    ...
                    <span
                        class="u-icon-v3 u-icon-size--lg g-bg-white g-color-black g-color-primary--hover g-font-size-20 g-rounded-50x g-cursor-pointer">
                        <i class="g-pos-rel g-left-2 fa fa-play"></i>
                    </span>
                </a>
                <span class="d-block g-color-white g-font-size-20 text-uppercase g-letter-spacing-5">Watch Unify
                    Intro</span>
            </div>
        </div>
    </section>
    ...
    <section class="g-bg-secondary">
        <div class="container g-py-100">
            <div class="g-mb-50">
                ...
                <span class="d-block g-font-weight-300 g-font-size-22 mr-4 g-mb-6">Our delighted clients we work
                    with</span>
            </div>
            ...
            <div class="row no-gutters">
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="g-brd-around g-brd-gray-light-v5 g-bg-white text-center">
                        <a class="d-block u-block-hover g-opacity-0_3 g-opacity-1--hover g-color-black g-transition-0_3 g-px-30 g-py-70"
                            href="#!">
                            <img class="u-block-hover__main--zoom-v1 u-block-hover__main--grayscale g-width-100"
                                src="{{ URL::asset('build/assets/img-temp/200x100/img2.png') }}" alt="Image Description">
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="g-brd-around g-brd-gray-light-v5 g-bg-white text-center">
                        <a class="d-block u-block-hover g-opacity-0_3 g-opacity-1--hover g-color-black g-transition-0_3 g-px-30 g-py-70"
                            href="#!">
                            <img class="u-block-hover__main--zoom-v1 u-block-hover__main--grayscale g-width-100"
                                src="{{ URL::asset('build/assets/img-temp/200x100/img5.png') }}" alt="Image Description">
                            <span class="d-block u-block-hover__additional--partially-slide-up py-2">
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="g-brd-around g-brd-gray-light-v5 g-bg-white text-center">
                        <a class="d-block u-block-hover g-opacity-0_3 g-opacity-1--hover g-color-black g-transition-0_3 g-px-30 g-py-70"
                            href="#!">
                            <img class="u-block-hover__main--zoom-v1 u-block-hover__main--grayscale g-width-100"
                                src="{{ URL::asset('build/assets/img-temp/200x100/img1.png') }}" alt="Image Description">
                            <span class="d-block u-block-hover__additional--partially-slide-up py-2">
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="g-brd-around g-brd-gray-light-v5 g-bg-white text-center">
                        <a class="d-block u-block-hover g-opacity-0_3 g-opacity-1--hover g-color-black g-transition-0_3 g-px-30 g-py-70"
                            href="#!">
                            <img class="u-block-hover__main--zoom-v1 u-block-hover__main--grayscale g-width-100"
                                src="{{ URL::asset('build/assets/img-temp/200x100/img6.png') }}" alt="Image Description">
                            <span class="d-block u-block-hover__additional--partially-slide-up py-2">
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="g-brd-around g-brd-gray-light-v5 g-bg-white text-center">
                        <a class="d-block u-block-hover g-opacity-0_3 g-opacity-1--hover g-color-black g-transition-0_3 g-px-30 g-py-70"
                            href="#!">
                            <img class="u-block-hover__main--zoom-v1 u-block-hover__main--grayscale g-width-100"
                                src="{{ URL::asset('build/assets/img-temp/200x100/img4.png') }}" alt="Image Description">
                            <span class="d-block u-block-hover__additional--partially-slide-up py-2">
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="g-brd-around g-brd-gray-light-v5 g-bg-white text-center">
                        <a class="d-block u-block-hover g-opacity-0_3 g-opacity-1--hover g-color-black g-transition-0_3 g-px-30 g-py-70"
                            href="#!">
                            <img class="u-block-hover__main--zoom-v1 u-block-hover__main--grayscale g-width-100"
                                src="{{ URL::asset('build/assets/img-temp/200x100/img3.png') }}" alt="Image Description">
                            <span class="d-block u-block-hover__additional--partially-slide-up py-2">
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="g-brd-around g-brd-gray-light-v5 g-bg-white text-center">
                        <a class="d-block u-block-hover g-opacity-0_3 g-opacity-1--hover g-color-black g-transition-0_3 g-px-30 g-py-70"
                            href="#!">
                            <img class="u-block-hover__main--zoom-v1 u-block-hover__main--grayscale g-width-100"
                                src="{{ URL::asset('build/assets/img-temp/200x100/img8.png') }}" alt="Image Description">
                            <span class="d-block u-block-hover__additional--partially-slide-up py-2">
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="g-brd-around g-brd-gray-light-v5 g-bg-white text-center">
                        <a class="d-block u-block-hover g-opacity-0_3 g-opacity-1--hover g-color-black g-transition-0_3 g-px-30 g-py-70"
                            href="#!">
                            <img class="u-block-hover__main--zoom-v1 u-block-hover__main--grayscale g-width-100"
                                src="{{ URL::asset('build/assets/img-temp/200x100/img7.png') }}" alt="Image Description">
                            <span class="d-block u-block-hover__additional--partially-slide-up py-2">
