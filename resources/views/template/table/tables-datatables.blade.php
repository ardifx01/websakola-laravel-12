                    ...
                    <table id="alternative-pagination"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('build/images/svg/crypto-icons/ant.svg') }}"
                                            alt="" class="avatar-xxs me-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('build/images/svg/crypto-icons/sol.svg') }}"
                                            alt="" class="avatar-xxs me-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('build/images/svg/crypto-icons/fil.svg') }}"
                                            alt="" class="avatar-xxs me-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('build/images/svg/crypto-icons/ada.svg') }}"
                                            alt="" class="avatar-xxs me-2">
