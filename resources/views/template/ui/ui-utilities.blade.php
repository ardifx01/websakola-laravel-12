    ...
    <div class="row">
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">Use <code>vstack</code> class to create vertical layouts.admin. Stacked
                        items are
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-3">Use <code>hstack</code> class to create horizontal layouts.admin. Stacked
                        items
