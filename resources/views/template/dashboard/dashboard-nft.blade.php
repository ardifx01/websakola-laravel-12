                                    ...
                                    <div class="border-start p-4 h-100 d-flex flex-column">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="row mt-4 pt-2">
                                                <div class="col">
                                                    <a href="/apps_nft_item_details" class="btn btn-primary w-100">View
                                                        Details</a>
                                                </div>
                                                <div class="col">
        ...
        <div class="col-xxl-3">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <a class="text-muted" href="/apps_nft_item_details">
                        ...
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    37.41k </p>
                                <h5 class="mb-1"><a href="/apps_nft_item_details">Walking On Air</a></h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    19.29k </p>
                                <h5 class="mb-1"><a href="/apps_nft_item_details">Filtered Portrait</a></h5>
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    8.42k </p>
                                <h5 class="mb-1"><a href="/apps_nft_item_details">Patterns Arts & Culture</a></h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                            <div class="card-footer border-top border-top-dashed">
                                <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps_nft_item_details">Abstract Face
                                                        Painting</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps_nft_item_details">Long-tailed
                                                        Macaque</a>
                                                </h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps_nft_item_details">Robotic Body Art</a>
                                                </h6>
                                                <p class="text-muted mb-0">Photography</p>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps_nft_item_details">Smillevers Crypto</a>
                                                </h6>
                                                <p class="text-muted mb-0">Artworks</p>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps_nft_item_details">Creative Filtered
                                                        Portrait</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps_nft_item_details">The Chirstoper</a>
                                                </h6>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <a href="/apps_nft_collections" type="button" class="btn btn-soft-primary btn-sm flex-shrink-0">
                        See All <i class="ri-arrow-right-line align-bottom"></i>
                    </a>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <a href="/apps_nft_creators" type="button" class="btn btn-soft-primary btn-sm flex-shrink-0">
                        See All <i class="ri-arrow-right-line align-bottom"></i>
                    </a>
                </div>
                <div class="card-body">
