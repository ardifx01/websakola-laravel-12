            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                        ...
                        <div class="flex-shrink-0">
                            <a href="/pages_pricing" class="text-reset text-decoration-underline"><b>Upgrade</b></a>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-end">
                        <div class="col-sm-8">
                            <div class="p-3">
                                ...
                                <div class="mt-3">
                                    <a href="/pages_pricing" class="btn btn-success">Upgrade Account!</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row align-items-end">
                        <div class="col-sm-8">
                            <div class="p-3">
                                ...
                                <div class="mt-3">
                                    <a href="/pages_pricing" class="btn btn-info">Upgrade Account!</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                        ...
                        <div class="flex-shrink-0">
                            <a href="/pages_pricing" class="text-reset text-decoration-underline"><b>Get Free
                                    Gift</b></a>
                        </div>
                    </div>
                    <div class="d-flex p-3">
                        ...
                        <div>
                            ...
                            <div class="mt-3">
                                <a href="/pages_pricing" class="btn btn-secondary">Get a Free Gift</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- end card-body-->
                            ...
                            <div data-simplebar style="max-height: 364px;" class="p-3">
                                <div class="acitivity-timeline acitivity-main">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2 w-75">
                                                <a href="/apps_ecommerce_product_details" class="bg-light rounded p-1">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1">Today offers by <a href="/apps_ecommerce_seller_details"
                    ...
                    <ul class="list-group list-group-flush border-dashed mb-0">
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="{{ URL::asset('build/images/svg/crypto-icons/btc') }} class="img-fluid"
                                            alt="">
                                    </span>
                                </div>
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="{{ URL::asset('build/images/svg/crypto-icons/ltc') }} class="img-fluid"
                                            alt="">
                                    </span>
                                </div>
                                <div class="flex-grow-1 ms-2">
                        ...
                        <li class="list-group-item px-0 pb-0">
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="{{ URL::asset('build/images/svg/crypto-icons/dash') }} class="img-fluid"
                                            alt="">
                                    </span>
                                </div>
                                <div class="flex-grow-1 ms-2">
