            ...
            <div class="card bg-primary" style="background-image: url('build/images/nft/bg-pattern.png');">
                <div class="card-body p-4">
                    ...
                    <div class="hstack gap-2">
                        <a href="/apps_nft_create" class="btn btn-success">Create NFT</a>
                        <a href="/apps_nft_explore" class="btn btn-danger">Explore Now</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="d-lg-flex align-items-center mb-4">
                ...
                <div class="flex-shrink-0 mt-4 mt-lg-0">
                    <a href="/apps_nft_explore" class="btn btn-soft-primary">View All <i
                            class="ri-arrow-right-line align-bottom"></i></a>
                </div>
            </div>
        </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-16 mb-0"><a href="/apps_nft_item_details">Patterns Arts & Culture</a></h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-16 mb-0"><a href="/apps_nft_item_details">Long-tailed Macaque</a></h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-16 mb-0"><a href="/apps_nft_item_details">Robotic Body Art</a></h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-16 mb-0"><a href="/apps_nft_item_details">Creative Filtered Portrait</a></h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-lg-flex align-items-center mb-4">
                ...
                <div class="flex-shrink-0 mt-4 mt-lg-0">
                    <a href="/apps_nft_creators" class="btn btn-soft-primary">View All <i
                            class="ri-arrow-right-line align-bottom"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-1"><a href="/apps_nft_item_details">Trendy Fashion Portraits</a></h5>
        ...
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-1"><a href="/apps_nft_item_details">Smillevers Crypto</a></h5>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <h5 class="mt-3 mb-1"><a href="/pages_profile_basic">Tonya Noble</a></h5>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img src="{{ URL::asset('build/images/nft/img-04.jpg') }}" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                    <h5 class="mt-3 mb-1"><a href="/pages_profile_basic">Kevin Dawson</a></h5>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img src="{{ URL::asset('build/images/nft/img-06.jpg') }}" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                    <h5 class="mt-3 mb-1"><a href="/pages_profile_basic">Herbert Stokes</a></h5>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                    <h5 class="mt-3 mb-1"><a href="/pages_profile_basic">Thomas Taylor</a></h5>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                    <h5 class="mt-3 mb-1"><a href="/pages_profile_basic">James Price</a></h5>
