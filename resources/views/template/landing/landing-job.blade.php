            ...
            <nav class="navbar navbar-expand-lg navbar-landing fixed-top job-navbar" id="navbar">
                <div class="container-fluid custom-container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="">
                            <a href="/auth_signin_basic" class="btn btn-soft-primary"><i
                    ...
                    <div class="row align-items-center gy-4">
                        <div class="col-lg-6 order-2 order-lg-1">
                            <div class="text-muted mt-5 mt-lg-0">
                                ...
                                <div class="mt-4">
                                    <a href="/dashboard" class="btn btn-primary">View More Companies <i
                        ...
                        <div class="col-lg-7 ms-lg-auto">
                            <div class="row">
                                <div class="col-sm-4 mt-4">
                                    ...
                                    <div class="text-muted mt-3">
                                        <ul class="list-unstyled ff-secondary footer-list">
                                            <li><a href="/pages_profile">About Us</a></li>
                                            <li><a href="/pages_gallery">Gallery</a></li>
                                            <li><a href="/pages_team">Team</a></li>
                                            <li><a href="/pages_pricing">Pricing</a></li>
                                ...
                                <div class="col-sm-4 mt-4">
                                    ...
                                    <div class="text-muted mt-3">
                                        <ul class="list-unstyled ff-secondary footer-list">
                                            <li><a href="/apps_job_lists">Job List</a></li>
                                            <li><a href="/apps_job_application">application</a></li>
                                            <li><a href="/apps_job_new">New Job</a></li>
                                            <li><a href="/apps_job_companies_lists">Company List</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-sm-4 mt-4">
