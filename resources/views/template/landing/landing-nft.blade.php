            ...
            <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="">
                            <a href="/apps_nft_wallet" class="btn btn-success">Wallet Connect</a>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8 col-sm-10">
                            <div class="text-center">
                                ...
                                <div class="hstack gap-2 justify-content-center">
                                    <a href="/apps_nft_create" class="btn btn-primary">Create Own <i
                                            class="ri-arrow-right-line align-middle ms-1"></i></a>
                                    <a href="/apps_nft_explore" class="btn btn-danger">Explore Now <i
                                            class="ri-arrow-right-line align-middle ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    <img src="{{ URL::asset('build/images/nft/wallet/metamask.png') }}" alt=""
                        ...
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    <img src="{{ URL::asset('build/images/nft/wallet/coinbase.png') }}" alt=""
                                        height="55" class="mb-3 pb-2">
                        ...
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    <img src="{{ URL::asset('build/images/nft/wallet/binance.png') }}" alt=""
                                        height="55" class="mb-3 pb-2">
                                    <h5>Binance</h5>
                        ...
                        <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="/apps_nft_item_details">Creative Filtered Portrait</a>
                                    </h5>
                        ...
                        <div class="col-lg-4 product-item music crypto-card games">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="/apps_nft_item_details">The Chirstoper</a></h5>
                        ...
                        <div class="col-lg-4 product-item artwork music games">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="/apps_nft_item_details">Evolved Reality</a></h5>
                        ...
                        <div class="col-lg-4 product-item crypto-card 3d-style">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="/apps_nft_item_details">Abstract Face Painting</a></h5>
                        ...
                        <div class="col-lg-4 product-item games music 3d-style">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="/apps_nft_item_details">Long-tailed Macaque</a></h5>
                        ...
                        <div class="col-lg-4 product-item artwork music crypto-card">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="/apps_nft_item_details">Robotic Body Art</a></h5>
                                    <p class="text-muted mb-0">Artwork</p>
                                </div>
                                <div class="card-footer border-top border-top-dashed">
                                    <div class="d-flex align-items-center">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('build/images/nft/wallet.png') }}" alt=""
                                        class="avatar-sm">
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('build/images/nft/money.png') }}" alt=""
                                        class="avatar-sm">
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('build/images/nft/add.png') }}" alt=""
                                        class="avatar-sm">
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('build/images/nft/sell.png') }}" alt=""
                                        class="avatar-sm">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row g-1 mb-3">
                                                    <div class="col-6">
                                                        <img src="{{ URL::asset('build/images/nft/img-05.jpg') }}"
                                                            alt="" class="img-fluid rounded">
                                                    ...
                                                    <div class="col-6">
                                                        <img src="https://img.themesbrand.com/velzon/images/img-4.gif"
                                                            alt="" class="img-fluid rounded mb-1">
                                                        <img src="{{ URL::asset('build/images/nft/img-04.jpg') }}"
                                                            alt="" class="img-fluid rounded">
                                                    </div>
                                                    <!--end col-->
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row g-1 mb-3">
                                                    <div class="col-6">
                                                        <img src="{{ URL::asset('build/images/nft/img-02.jpg') }}"
                                                            alt="" class="img-fluid rounded">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <a href="/apps_nft_explore" class="btn btn-primary">View All <i
                                        class="ri-arrow-right-line align-bottom"></i></a>
                            </div>
                        </div>
                    </div><!-- end row -->
                            ...
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="/apps_nft_item_details">Patterns arts &amp;
                                                culture</a></h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="/apps_nft_item_details">Evolved Reality</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="/apps_nft_item_details">Long-tailed macaque</a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row align-items-center gy-4">
                        ...
                        <div class="col-sm-auto">
                            <div>
                                <a href="/apps_nft_create" class="btn bg-gradient btn-danger">Create NFT</a>
                                <a href="/apps_nft_explore" class="btn bg-gradient btn-info">Discover More</a>
                            </div>
                        </div>
                        <!-- end col -->
                    </div>
